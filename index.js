...
const GOOGLE_SCRIPT_URL_THAM_DU =
  "https://script.google.com/macros/s/AKfycbwr7Em5PFWzhxeu6gOiEzh9L2IMBxYyiqTdbuIGkRJuKILDT9bMxmXSAOmVuoNx9iuG/exec";
document
  .querySelector("#form-loi-chuc-1")
  .addEventListener("submit", function (e) {
    e.preventDefault();
    document.getElementById("SECTION21").scrollIntoView({
      behavior: "smooth",
      block: "start",
    });
